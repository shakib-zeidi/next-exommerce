import Index from "@/components/admin/tags/Index";
import { Search } from "lucide-react";
import Link from "next/link";

export default async function IndexTagsPage() {
  return (
    <section>
      <div className="flex justify-between items-center">
        <h1 className="text-xl">لیست تگ ها</h1>
        ...
        <Link
          href="/admin-panel/management/tags/create"
